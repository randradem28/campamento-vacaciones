...
public class ActLider extends JFrame implements ActionListener {
    ...
    public ActLider() {
        ...
        setTitle("Actualización de Líderes de Grupo");
        setSize(600, 600);
        ...
        // Nombre del sistema
        JLabel lblTitulo = new JLabel("ACTUALIZACIÓN DE LÍDERES");
        ...
        try {
            ...
            try (Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/entretenimientovacaciones","root","");
                ...
                if (rs.next()) {
                    ...
                    tableModel.addColumn("DATOS ACTUALES");
                    tableModel.addColumn(" ");
                    tableModel.addRow(new Object[]{"C.I: "+ci});
                    tableModel.addRow(new Object[]{"NOMBRE: "+ nombre, "ACTUALIZAR"});
                    tableModel.addRow(new Object[]{"TELÉFONO: "+ telefono, "ACTUALIZAR"});
                    tableModel.addRow(new Object[]{"EMAIL: "+ correo, "ACTUALIZAR"});
